...
export default function IncomeEditor({ incomes, hospitalList, onChange, onAdd, onRemove }) {
    return (
                ...
                <div key={index} className="relative p-4 border rounded-lg bg-white">
                    ...
                    <div className="mb-3">
                        ...
                        <select
                            ...
                            className="w-full p-2 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#C89F74]"
                        >
                    ...
                    <div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <input
                                ...
                                className="w-full sm:w-1/2 p-2 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#C89F74] text-right"
                            />
                        </div>
                    </div>
                </div>
